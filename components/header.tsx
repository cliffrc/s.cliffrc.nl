...
export default function Header() {
  return (
    <header className="z-[999] relative">
      ...
      ></motion.div>
      <nav className="flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:py-0 sm:h-[initial]">
        <ul className="flex flex-wrap w-[22rem] items-center justify-center gap-y-1 text-gray-500 font-medium sm:flex-nowrap">
          {links.map((link) => (
            <motion.li
